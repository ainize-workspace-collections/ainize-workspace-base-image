...
ENV NVARCH x86_64
ENV NVIDIA_REQUIRE_CUDA "cuda>={CUDA_DOT_VERSION} brand=tesla,driver>=418,driver<419"
...
ENV NCCL_VERSION {NCCL_VERSION}
ENV NV_LIBNCCL_DEV_PACKAGE ${{NV_LIBNCCL_DEV_PACKAGE_NAME}}=${{NV_LIBNCCL_DEV_PACKAGE_VERSION}}+{CUDA_DOT_VERSION}
